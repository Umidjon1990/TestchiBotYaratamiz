...
3. أنشئ 2 أسئلة اختيار من متعدد **صَعْبَةً وَمُحَيِّرَةً** حول المحتوى مع التشكيل (لِلاخْتِبَارِ فَقَطْ)
...
`;
      ...
      try {
        ...
        // Fallback: use Arabic default content with CHALLENGING questions
        logger?.warn("⚠️ Failed to parse JSON, using default Arabic content with challenging questions");
        podcastData = {
          ...
          questions: [
            {
              ...
              options: [
                ...
                "تَسْرِيعُ عَمَلِيَّةِ التَّعَلُّمِ مِنْ خِلَالِ التَّطْبِيقَاتِ الْحَدِيثَةِ",
                "تَقْلِيلُ الْحَاجَةِ إِلَى الْمَدَارِسِ التَّقْلِيدِيَّةِ",
                "زِيَادَةُ كَمِّيَّةِ الْوَاجِبَاتِ الْمَدْرَسِيَّةِ",
              ],
              correctAnswer: 1,
              explanation: "النَّصُّ يُشِيرُ إِلَى أَنَّ التَّطْبِيقَاتِ الجَدِيدَةَ تُسَاعِدُ عَلَى التَّعَلُّمِ بِسُرْعَةٍ، وَلَيْسَ اسْتِبْدَالَ الْمُعَلِّمِينَ.",
            },
            {
              question: "أَيُّ جَانِبٍ مِنْ جَوَانِبِ التَّعْلِيمِ تُرَكِّزُ عَلَيْهِ التِّقْنِيَّاتُ الجَدِيدَةُ بِشَكْلٍ خَاصٍّ؟",
              options: [
                "تَوْفِيرُ دُرُوسٍ مُوَحَّدَةٍ لِجَمِيعِ الطُّلَّابِ",
                "تَخْصِيصُ الْمَوَادِّ التَّعْلِيمِيَّةِ لِكُلِّ مُتَعَلِّمٍ",
                "تَقْلِيلُ الْوَقْتِ الْمُخَصَّصِ لِلدِّرَاسَةِ",
                "إِلْغَاءُ الامْتِحَانَاتِ التَّقْلِيدِيَّةِ",
              ],
              correctAnswer: 1,
              explanation: "النَّصُّ يَذْكُرُ أَنَّ التِّقْنِيَّاتِ تُقَدِّمُ دُرُوساً شَخْصِيَّةً، أَيْ مُخَصَّصَةً لِكُلِّ طَالِبٍ.",
            },
          ],
        };
      }
