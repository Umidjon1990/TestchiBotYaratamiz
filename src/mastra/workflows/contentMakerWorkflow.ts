...
const generateContentWithAgent = createStep({
  ...
  execute: async ({ inputData, mastra }) => {
    ...
    try {
      ...
      // Level-specific difficulty instructions - ENHANCED FOR HARDER QUESTIONS
      const levelDifficulty = {
        "A1": `الأسئلة يَجِبُ أَنْ تَكُونَ سَهْلَةً - مَعْلُومَاتٌ أَسَاسِيَّةٌ مِنَ النَّصِّ
        - الخيارات الخطأ يجب أن تكون مختلفة تماماً عن الإجابة الصحيحة
        - لكن يجب أن تبدو معقولة ومنطقية للمبتدئين`,
        
        "A2": `الأسئلة يَجِبُ أَنْ تَكُونَ سَهْلَةً إِلَى مُتَوَسِّطَةٍ - مَعْلُومَاتٌ وَاضِحَةٌ مَعَ قَلِيلٍ مِنَ الاسْتِنْتَاجِ
        - الخيارات الخطأ يجب أن تكون قريبة من الموضوع لكن ليست في النص
        - اجعل 1-2 من الخيارات الخطأ تبدو صحيحة للوهلة الأولى`,
        
        "B1": `الأسئلة يَجِبُ أَنْ تَكُونَ مُتَوَسِّطَةَ الصُّعُوبَةِ - تَحْتَاجُ فَهْمًا عَمِيقًا وَرَبْطَ الأَفْكَارِ
        - استخدم أسئلة استنتاجية (ما السبب؟ ما النتيجة؟ ما العلاقة؟)
        - الخيارات الخطأ يجب أن تكون منطقية جداً وقريبة من الصواب
        - اجعل 2-3 خيارات تبدو صحيحة - يحتاج الطالب للتفكير العميق للاختيار`,
        
        "B2": `الأسئلة يَجِبُ أَنْ تَكُونَ صَعْبَةً - تَحْتَاجُ تَحْلِيلًا نَقْدِيًّا وَفَهْمًا شَامِلًا
        - استخدم أسئلة تحليلية معقدة (لماذا؟ كيف؟ ما التأثير؟ ما الاستنتاج؟)
        - جميع الخيارات يجب أن تبدو صحيحة ومنطقية
        - الفرق بين الصواب والخطأ يجب أن يكون دقيقاً جداً
        - اجعل 3 خيارات على الأقل تبدو صحيحة للخبراء أيضاً`
      };
...
**مُهِمٌّ لِلأَسْئِلَةِ - مُسْتَوَى ${level}:**
${levelDifficulty[level as keyof typeof levelDifficulty] || levelDifficulty["B1"]}

**قَوَاعِد الأَسْئِلَةِ المُحَسَّنَة - لِاخْتِبَارَاتٍ أَكْثَرَ صُعُوبَةً:**

1. **عدد الأسئلة:** 5 أسئلة بالضبط - لا أكثر ولا أقل

2. **استخدام المرادفات في الأسئلة:**
   - مُسْتَوَى A1: استخدم نفس الكلمات من النص أو مرادفات بسيطة جداً
   - مُسْتَوَى A2: استخدم مرادفات بسيطة ومألوفة
   - مُسْتَوَى B1: استخدم مرادفات متوسطة التعقيد وأسئلة استنتاجية
   - مُسْتَوَى B2: استخدم مرادفات متقدمة ومعقدة وأسئلة تحليلية

3. **الْخِيَارَاتُ الخَطَأُ - قَوَاعِد صَارِمَة لِزِيَادَةِ الصُّعُوبَةِ:**
   - **يُمْنَع مَنْعًا بَاتًّا:** خيارات سخيفة أو غير منطقية أو واضحة الخطأ
   - **مُسْتَوَى A1:** 2 خيارات خطأ يجب أن تبدو معقولة للمبتدئ، 1 خيار واضح الخطأ
   - **مُسْتَوَى A2:** 3 خيارات خطأ يجب أن تبدو معقولة، واحد منها قريب جداً من الصواب
   - **مُسْتَوَى B1:** جميع الخيارات الخطأ يجب أن تبدو صحيحة ومنطقية جداً
   - **مُسْتَوَى B2:** جميع الخيارات يجب أن تكون منطقية ومبنية على معلومات حقيقية - الفرق دقيق جداً
   
4. **أنواع الأسئلة حسب المستوى:**
   - **A1:** أسئلة مباشرة (ماذا؟ من؟ متى؟ أين؟)
   - **A2:** أسئلة استيعاب (كيف؟ ماذا يحدث؟)
   - **B1:** أسئلة استنتاجية (لماذا؟ ما السبب؟ ما النتيجة؟ ما العلاقة؟)
   - **B2:** أسئلة تحليلية معقدة (ما التأثير؟ ما الاستنتاج؟ ما الهدف الضمني؟ كيف يرتبط؟)

5. **تَنْوِيعُ الإِجَابَاتِ الصَّحِيحَةِ - مُهِمٌّ جِدًّا:**
   - السُّؤَالُ 1: ضَعِ الإِجَابَةَ الصَّحِيحَةَ فِي مَوْضِعٍ مُعَيَّنٍ (مَثَلاً: A أَوْ C أَوْ D)
   - السُّؤَالُ 2: ضَعِ الإِجَابَةَ الصَّحِيحَةَ فِي مَوْضِعٍ مُخْتَلِفٍ (مَثَلاً: B أَوْ D)
   - السُّؤَالُ 3: ضَعِ الإِجَابَةَ الصَّحِيحَةَ فِي مَوْضِعٍ آخَرَ (مَثَلاً: C أَوْ A)
   - السُّؤَالُ 4: ضَعِ الإِجَابَةَ الصَّحِيحَةَ فِي مَوْضِعٍ مُخْتَلِفٍ (مَثَلاً: D أَوْ B)
   - السُّؤَالُ 5: ضَعِ الإِجَابَةَ الصَّحِيحَةَ فِي مَوْضِعٍ مُتَنَوِّعٍ (مَثَلاً: A أَوْ C)
   - **لَا تَجْعَلْ كُلَّ الإِجَابَاتِ A أَوْ B فَقَطْ - نَوِّعْ بَيْنَ A وَ B وَ C وَ D**

لكل سؤال:
- نص السؤال
- 4 خيارات (A, B, C, D) - رَتِّبِ الْخِيَارَاتِ بِحَيْثُ تَكُونَ الإِجَابَةُ الصَّحِيحَةُ فِي مَوَاضِعَ مُخْتَلِفَةٍ
- رقم الإجابة الصحيحة (0 = A, 1 = B, 2 = C, 3 = D)
- شرح مختصر
...
`;
      ...
      try {
        ...
        // Fallback: use Arabic default content with 5 questions
        logger?.warn("⚠️ Failed to parse JSON, using default Arabic content with 5 questions");
        ...
        podcastData = {
          ...
          questions: [
            ...
            {
              question: "مَا الَّذِي تُشِيرُ إِلَيْهِ الدِّرَاسَاتُ بِشَأْنِ تَأْثِيرِ الذَّكَاءِ الاصْطِنَاعِيِّ عَلَى التَّعَلُّمِ؟",
              options: [
                "تَأْثِيرٌ سَلْبِيٌّ عَلَى نَتَائِجِ الطُّلَّابِ",
                "عَدَمُ وُجُودِ تَأْثِيرٍ وَاضِحٍ",
                "تَأْثِيرٌ ضَعِيفٌ جِدًّا",
                "تَحْسِينٌ كَبِيرٌ فِي نَتَائِجِ التَّعَلُّمِ",
              ],
              correctAnswer: 3,
              explanation: "النَّصُّ يَذْكُرُ أَنَّ الدِّرَاسَاتِ تُشِيرُ إِلَى تَحْسِينٍ كَبِيرٍ فِي نَتَائِجِ التَّعَلُّمِ.",
            },
            {
              question: "مَا هِيَ الْمَهَارَاتُ الَّتِي يَظَلُّ الْمُعَلِّمُ البَشَرِيُّ ضَرُورِيًّا لِتَطْوِيرِهَا؟",
              options: [
                "الْمَهَارَاتُ الاجْتِمَاعِيَّةُ وَالإِبْدَاعِيَّةُ",
                "الْمَهَارَاتُ التِّقْنِيَّةُ فَقَطْ",
                "مَهَارَاتُ الْحَاسُوبِ فَقَطْ",
                "مَهَارَاتُ الْحِفْظِ وَالتَّكْرَارِ",
              ],
              correctAnswer: 0,
              explanation: "النَّصُّ يُؤَكِّدُ أَنَّ الْمُعَلِّمَ البَشَرِيَّ أَسَاسِيٌّ فِي تَطْوِيرِ الْمَهَارَاتِ الاجْتِمَاعِيَّةِ وَالإِبْدَاعِيَّةِ.",
            },
          ],
        };
      }
