...
2. **استخدام المرادفات في الأسئلة:**
   ...
   - مُسْتَوَى B1: استخدم مرادفات متوسطة التعقيد
   - مُسْتَوَى B2: استخدم مرادفات متقدمة ومعقدة ومهنية
3. **الْخِيَارَاتُ الخَطَأُ:** يَجِبُ أَنْ تَكُونَ مُقْنِعَةً وَمَنْطِقِيَّةً وَمُتَنَوِّعَةً (لَيْسَتْ وَاضِحَةً أَنَّهَا خَطَأٌ)
4. **تَنْوِيعُ الإِجَابَاتِ الصَّحِيحَةِ - مُهِمٌّ جِدًّا:**
